...
sed -i -e '5i#!define WITH_MULTIDOMAIN\' /usr/local/etc/kamailio/kamailio.cfg
sed -i -e '6i#!define WITH_NAT\' /usr/local/etc/kamailio/kamailio.cfg
sed -i -e '7i#!define WITH_ANTIFLOOD\' /usr/local/etc/kamailio/kamailio.cfg
